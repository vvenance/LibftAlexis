...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/02 05:39:13 by aaverty           #+#    #+#             */
/*   Updated: 2016/02/08 19:01:47 by aaverty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/ft_printf.h"

static int	len_of_n(char n, t_args args)
{
	int		len;
	int		neg;
...
static char	*do_printf_d(char *str, char n, int len, t_args args)
{
	int		i;
